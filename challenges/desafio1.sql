...
CREATE TABLE SpotifyClone.planos(
    ...
    assinatura_valor DECIMAL(4,2) NOT NULL
);
...
CREATE TABLE SpotifyClone.usuario(
    ...
    FOREIGN KEY (plano_id) REFERENCES SpotifyClone.planos(assinatura_id)
);
...
INSERT INTO SpotifyClone.planos (assinatura_nome, assinatura_valor)
VALUES
("gratuito", 0),
("familiar", 7.99),
("universitário", 5.99),
...
INSERT INTO SpotifyClone.usuario (usuario_nome, usuario_idade, plano_id, data_assinatura)
VALUES
...
INSERT INTO SpotifyClone.cancoes (titulo, duracao, album_id)
VALUES
("BREAK MY SOUL", 279, 1),
